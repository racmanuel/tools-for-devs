 ...
 * of control:
 *
 * - Check if the $_REQUEST['plugin'] content actually is tools-for-devs/tools-for-devs.php
 ...
 * @since 1.0.0
 */
function tools_for_devs_uninstall() {

	if ( ! defined( 'WP_UNINSTALL_PLUGIN' )
		|| empty( $_REQUEST )
		|| ! isset( $_REQUEST['plugin'] )
		|| ! isset( $_REQUEST['action'] )
		|| 'tools-for-devs/tools-for-devs.php' !== $_REQUEST['plugin']
